<h2 class="tieude">Lịch sử  đơn hàng</h2>
<?php
  //liệt kê đơn hàng
    $id_khachhang=$_SESSION['id_khachhang'];
    $sql_lietke_dh = "SELECT * FROM tbl_donhang,tbl_dangky WHERE tbl_donhang.id_khachhang=tbl_dangky.id_dangky AND tbl_donhang.id_khachhang='$id_khachhang' ORDER BY tbl_donhang.id_donhang DESC";
...
?>
     ...
     <td>
      ...
      <td><a href="index.php?quanly=xemdonhang&code=<?php echo $row['code_cart'] ?>"><button type="button" class="btn btn-primary"><i class="fa fa-eye" aria-hidden="true"></i></button></a>
</td>
